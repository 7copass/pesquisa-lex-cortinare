    ...
    return (
        <div className="text-center p-8 flex flex-col items-center justify-center animate-fade-in">
            ...
            <p className="text-lg text-brand-blue/90 max-w-md">
                Sua participação foi registrada com sucesso. Suas respostas são muito importantes para nós e ajudarão a criar uma experiência ainda melhor na Lex Cortinare para você.
            </p>
        </div>
    );
};